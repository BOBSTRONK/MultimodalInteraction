            ...
            try:
                with sr.Microphone() as mic:
                    ...
                    if self.check_for_keywords(text) == 'next':
                        self.value = 'next'
                        os.system('osascript -e \'display notification "Switch to Next slide" with title "Voice recognition"\'')
                        print("next")
                    elif self.check_for_keywords(text) == 'previous':
                        self.value = 'previous'
                        os.system('osascript -e \'display notification "Switch to Previous slide" with title "Voice recognition"\'')
                        print('previous')
